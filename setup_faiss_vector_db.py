...
def setup_faiss_db():
    try:
        ...
        # Get all .txt files in the data directory that don't end with '_mermaid.txt'
        txt_files = [f for f in os.listdir(data_dir) if f.endswith('.txt') and not f.endswith('_mermaid.txt')]
